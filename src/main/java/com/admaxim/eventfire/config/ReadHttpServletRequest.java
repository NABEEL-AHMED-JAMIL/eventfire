...
public class ReadHttpServletRequest extends HttpServletRequestWrapper {
    ...
    public ReadHttpServletRequest(HttpServletRequest request) throws IOException {
        ...
        log.info("header "+getHeader()+", body "+getBody());
    ...
    public ServletInputStream getInputStream() throws IOException {
        final ByteArrayInputStream byteArrayInputStream =
                new ByteArrayInputStream(this.body.getBytes());
    ...
    public synchronized void setBody(String body) { this.body += body; }
    public synchronized void setHeader(String header) { this.header = header; }
